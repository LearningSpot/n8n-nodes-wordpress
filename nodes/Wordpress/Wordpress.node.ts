...
export class Wordpress implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'LearningSpot@Wordpress',
		name: 'wordpress',
				...
				if (resource === 'post') {
					...
					if (operation === 'create') {
                        ...
                        if (additionalFields.featuredMediaId) {
                            body.featured_media_id = additionalFields.featuredMediaId as number;
                        }
					...
					if (operation === 'update') {
                        ...
                        if (updateFields.featuredMediaId) {
                            body.featured_media_id = updateFields.featuredMediaId as number;
                        }
